...
class ItemDropsResultsHeader extends JPanel {
    ...
    static {
        final BufferedImage arrowDown = ImageUtil.loadImageResource(ItemDropsPlugin.class, "/arrow_down.png");
    ...
    ItemDropsResultsHeader(String title, boolean ordered, boolean ascending) {
